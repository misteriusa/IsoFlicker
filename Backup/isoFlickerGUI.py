...
def generate_isochronic_tone(frequency, duration, sample_rate=44100, volume=0.5, carrier_frequency=100.0):
    ...
    mod_freq = frequency  # Use entrainment frequency for modulation  # Use entrainment frequency for modulation  # Modulation at same frequency as carrier
...
def main():
    """Main entry point for the IsoFlicker GUI application"""
    try:
